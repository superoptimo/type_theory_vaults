...
Property (2) is the entire point of [[Godels-Incompleteness-Theorems#The construction|the construction]]: $\Gamma^*$ is a *complete* finitely satisfiable theory — it has an opinion on every wff, one way or the other, with no undecided cases. That completeness is exactly what makes Act II possible.
