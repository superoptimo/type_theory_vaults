...
Enderton states the required property first, before the definition — exactly the "why before symbols" sequencing this book itself models:
...
- **Chapter 3 (Induction and Recursion on Freely Generated Sets)** formalizes the "trees" that Chapter 0 introduced only informally — the abstract induction principle is the rigorous replacement for "draw a picture of the tree and reason about it."
...
- **Chapter 16 (Arithmetization of Syntax)** reuses Theorem 0B's exact prime-power encoding technique, scaled up into full Gödel numbering — the mechanism, not just the idea, recurs.
